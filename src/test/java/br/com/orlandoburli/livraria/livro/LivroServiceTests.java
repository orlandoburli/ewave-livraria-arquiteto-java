...
public class LivroServiceTests {
	...
	public void naoDeveCriarUmLivroComTituloNulo() {
		...
		ValidationLivrariaException exception = assertThrows(ValidationLivrariaException.class, () -> service.create(livro));
	...
	@Test
	public void deveAtualizarLivro() throws LivroNaoInformadoException, ValidationLivrariaException, LivroNaoEncontradoException {
		LivroDto livro = buildLivroRandom();
	...
	@Test
	public void naoDeveAtualizarLivroInexistente() throws LivroNaoInformadoException, ValidationLivrariaException, LivroNaoEncontradoException {
		assertThrows(LivroNaoEncontradoException.class, () -> service.update(buildLivroRandom()));		
	}
	
	@Test
	public void naoDeveAtualizarLivroExcluido() throws LivroNaoInformadoException, ValidationLivrariaException, LivroNaoEncontradoException {
		LivroDto livro = buildLivroRandom();
	...
	@Test
	public void deveExcluirLivro() throws LivroNaoInformadoException, ValidationLivrariaException, LivroNaoEncontradoException {
		LivroDto livro = buildLivroRandom();
		...
		Livro excluido = this.repository.findById(created.getId()).orElseThrow(() -> new LivroNaoEncontradoException("Livro não encontrado nos testes"));
	...
	@Test
	public void naoDeveExcluirLivroInexistente() throws LivroNaoInformadoException, ValidationLivrariaException, LivroNaoEncontradoException {
		assertThrows(LivroNaoEncontradoException.class, () -> service.destroy(faker.random().nextLong()));		
	}
	
	@Test
	public void deveEncontrarLivro() throws LivroNaoInformadoException, ValidationLivrariaException, LivroNaoEncontradoException {
		LivroDto livro = buildLivroRandom();
	...
	@Test
	public void naoDeveEncontrarLivroExcluido() throws LivroNaoEncontradoException, LivroNaoInformadoException, ValidationLivrariaException {
		LivroDto livro = buildLivroRandom();
